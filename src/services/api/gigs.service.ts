...
import { ISellerGig } from '@jobhunt-microservices/jobhunt-shared';
...
class GigsService {
  constructor() {
    const axiosService: AxiosService = new AxiosService(`${config.GIG_BASE_URL}/api/v1/gigs`, 'gig');
...
export const gigsService: GigsService = new GigsService();
